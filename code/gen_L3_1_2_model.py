# -*- coding: utf-8 -*-
"""
Created on Sat Jun 30 16:00:50 2018
...
train_features = train_features[train_level != 0]
train_level = train_level[train_level != 0]
train_level = train_level - 1
dev_features = dev_features[dev_level != 0]
dev_level = dev_level[dev_level != 0]
dev_level = dev_level - 1
...
params={
        ...
        'seed':31,   #the seed of random data
...
joblib.dump(xgm, '../model/div_2_3_'+modality+'.model')